...
module.exports = {
  ...
  execute: async function(message, argsStr, embed) {
    ...
    try {
      ...
      const sql1 = 'INSERT INTO test_points (set_id, player_id, points, bonus, malus) VALUES ($1, $2, 0, 0, 0)'
      const values1 = [resSet.rows[0].id, player1.id]

      await db.query(sql1, values1)

      const sql2 = 'INSERT INTO test_points (set_id, player_id, points, bonus, malus) VALUES ($1, $2, 0, 0, 0)'
