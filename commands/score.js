...
module.exports = {
  ...
  execute: async function(message, argsStr, embed) {
    ...
    const sql1Malus = 'SELECT SUM(malus) AS malus, player_id FROM test_set INNER JOIN test_points ON set_id = id WHERE season = $1 AND player_id = $2 AND set_id = $3 GROUP BY player_id'
    ...
    const sql2Malus = 'SELECT SUM(malus) AS malus, player_id FROM test_set INNER JOIN test_points ON set_id = id WHERE season = $1 AND player_id = $2 AND set_id = $3 GROUP BY player_id'
